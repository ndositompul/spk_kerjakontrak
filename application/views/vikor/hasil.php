                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-info">
                            Rating Penilaian Alternatif Terhadap Kriteria
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="col-6">
        <div class="card shadow-sm border-bottom-info">
            <div class="card-header bg-dark py-3">
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-info text-center">
                            Menghitung Nilai S<sub>i</sub>
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm border-bottom-info">
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-info">
                            Normalisasi Nilai S Dan Nilai R
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    echo "= (0.5((" . $hasilS[$matrikskeputusan['cu_alternatif']] . " - " . $maxS . ") / (" . $minS . "-" . $maxS . "))) + ((1-0.5)(" . $hasilR[$matrikskeputusan['cu_alternatif']] . " - ".$maxR.") / (".$minR."-".$maxR."))";
                                    echo "<br>";
        ...
        <div class="card shadow-sm border-bottom-info">
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-info">
                            Normalisasi Hitung Indeks Vikor
                        </h4>
                    </div>
                </div>
            </div>
